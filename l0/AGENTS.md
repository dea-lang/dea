...
Read `CLAUDE.md` in this directory first and treat it as the primary source of truth for project scope, commands,
...
- Follow the remote and publication authorization policy in the root `CLAUDE.md`; a local commit, release plan, green
