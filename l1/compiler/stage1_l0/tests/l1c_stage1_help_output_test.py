...
def main() -> int:
    ...
    expected_fragments = (
        ...
        "           [-Rr RPATH]... [-Cl LINK_ARG]... [-I INTERFACE_PATH]... [-e MODULE] -o OUTPUT",
        ...
        "'--build', '--compile', '--gen', '--link', '--run';",
        "searched in declaration order)",
        "       l1c --prepare-stdlib [--force] [--stdlib-cache DIR]",
        "  --prepare-stdlib      Prepare reusable bundled native modules and matching runtime",
    ...
    retired_fragments = (
        ...
        "--no-stdlib-cache", "--system-stdlib-cache", "--cache-scope", "--clean-cache", "--scrub",
        "L1_SYSTEM_STDLIB_CACHE",
