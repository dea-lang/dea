...
/**
 * @file compiler_support.c
 * Common compiler-private filesystem and process support for both L1 stages.
 * Paths and arguments cross the FFI as explicit native byte spans.
 */
