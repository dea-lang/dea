...
allocator. AddressSanitizer builds poison retained user payloads until eviction so direct stale C accesses remain
sanitizer-visible. The quarantine limits default to 16 MiB and 4096 records and can be retuned per process through the
